...
export function TaskConfigDialog({
  ...
  const handleCreate = async () => {
    ...
    if (actionType === 'prompt') {
      ...
      if (selectedModel)
        action.model = `${selectedModel.providerID}/${selectedModel.modelID}`;
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Button
                  ...
                  variant="outline"
                  className={cn(
                    'flex flex-col items-center gap-2 p-4 h-auto rounded-xl border-2',
                    sourceType === 'cron'
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="rounded-xl bg-muted/50 border p-3 space-y-1.5">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Send a <span className="font-mono">POST</span> request to
                      this URL to fire the trigger.
                      {webhookSecret
                        ? ' Include the secret in the '
                        : ' Optionally protect with a secret via '}
                      <code className="text-xs font-mono">
                        X-Aether-Trigger-Secret
                      </code>{' '}
                      header.
                    </p>
                  </div>
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder='["-c", "./scripts/backup.sh"]'
                      className="rounded-xl"
                    />
                    <p className="text-xs text-muted-foreground">
                      JSON array or space-separated
                    </p>
                  </div>
                  <div className="space-y-2">
