...
Agent: ✓ Bot verified — @kortix_dev_04 in workspace
...
───────────────
┌──────────────────────────────────────────────────────────┐
│ 📱 Spark (by Marko)          Telegram  ● Active  │
│    @MarkosTestBot12_bot                                  │
│    Agent:Master | Model: claude-sonnet-4                │
│    [Edit] [Disable] [Delete]                             │
├──────────────────────────────────────────────────────────┤
│ 💬 Wave (by Marko)           Slack     ● Active  │
│    @kortix_dev_04 in workspace                    │
│    Agent:Master | Model: claude-sonnet-4                │
│    [Edit] [Disable] [Delete]                             │
└──────────────────────────────────────────────────────────┘
...
```json
{
  ...
  "description": "Telegram bot @MarkosTestBot12_bot — Spark (by Marko)",
  "source": "channel",
