 ...
 * 
 * Note: The backend should return yourbrand.com URLs that wrap/proxy Stripe,
...
// checkout URLs (should be yourbrand.com masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a yourbrand.com masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.yourbrand.com/subscription';
