...
import { PresentationSlidePreview } from '@/components/shared-ui/tool-views/presentation-tools/PresentationSlidePreview';
  ...
  if (alignRight) {
    return (
      <div className="w-full flex justify-end">
        <div className="max-w-[85%]">{card}</div>
      </div>
    );
  }
          ...
          {urls.map((url, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <IframePreview url={url} title={`Preview: ${domain}`} />
                </div>
