    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight flex items-center gap-2" data-testid="admin-access-requests-heading">
          ...
          <div className="flex gap-3">
            <div className="bg-foreground/[0.04] border border-foreground/[0.08] rounded-lg px-4 py-2 text-center min-w-[80px]" data-testid="access-summary-card">
        ...
        {admin.list.isLoading ? (
          ...
          <div className="border border-foreground/[0.08] rounded-xl overflow-hidden" data-testid="access-requests-table">
            <Table>
              <TableHeader>
