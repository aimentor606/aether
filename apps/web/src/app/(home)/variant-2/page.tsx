...
const AetherBoxScene = dynamic(() => import('@/components/landing/AetherBoxScene'), {
  ssr: false,
        ...
        <div ref={heroRef} className="relative h-[250vh]">
          ...
          >
            ...
            >
              ...
              >
                Launch Aether<ArrowRight className="ml-2 size-4" />
              </Button>
              ...
              <div>
                ...
                <Reveal delay={0.1}>
                  <p className="text-base text-muted-foreground/60 leading-relaxed mb-8">
                    Aether runs on <a href="https://opencode.ai" target="_blank" rel="noopener noreferrer" className="hover:text-foreground/80 transition-colors">OpenCode</a>, an open foundation for building knowledge work agents, with the Aether cognitive architecture layered on top. Everything is just files.
                  </p>
                </Reveal>
                <Reveal delay={0.2}>
                ...
                <div className="rounded-2xl overflow-hidden border border-border/40 bg-card/20 font-mono text-[11px]">
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="space-y-2 pl-3 border-l border-border/25">
                      <div className="text-muted-foreground/35 text-[0.5625rem] uppercase tracking-widest mb-3">Aether</div>
                      {[
