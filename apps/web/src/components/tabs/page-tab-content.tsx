...
const ChangelogPage = lazy(() => import('@/app/(dashboard)/changelog/page'));

const WorkspacePage = lazy(() => import('@/app/(dashboard)/workspace/page'));
...
function resolveComponent(
  routeKey: string,
): { Component: ComponentType<any>; params?: Record<string, string> } | null {
  ...
  if (legacyMatch) {
    return {
      Component: LegacyThreadPage,
      params: { threadId: legacyMatch[1] },
    };
  }
