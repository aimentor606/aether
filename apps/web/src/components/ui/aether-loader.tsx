...
/**
 * AetherLoader - A unified circular loading animation component
 *
 ...
 * <AetherLoader variant="white" />
 *
 * // Always black (for light backgrounds in any theme)
 * <AetherLoader variant="black" />
 *
 * // Custom size
    ...
    >
      <div
        style={{
          ...
          animation:
            autoPlay && loop
              ? `aether-spin ${animationDuration}s linear infinite`
              : autoPlay
                ? `aether-spin ${animationDuration}s linear`
                : 'none',
        }}
      />
    </div>
