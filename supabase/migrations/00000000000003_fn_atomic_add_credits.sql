...
BEGIN
    ...
    IF p_stripe_event_id IS NOT NULL THEN
        IF EXISTS (
            SELECT 1 FROM aether.credit_ledger
    ...
    IF NOT FOUND THEN
        ...
        INSERT INTO aether.credit_accounts (
    ...
    INSERT INTO aether.credit_ledger (
