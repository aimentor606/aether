/**
 * Adapter: OpenCode SDK ToolPart → AetherComputer ToolCallInput
 *
 * Converts OpenCode session messages into the ToolCallInput[] format
 * that AetherComputer expects, enabling the computer panel to display
 * OpenCode tool calls.
 */
