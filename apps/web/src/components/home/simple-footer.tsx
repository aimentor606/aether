      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center gap-1.5">
            {/* GitHub */}
            <a href="https://github.com/aimentor606/aether" target="_blank" rel="noopener noreferrer" aria-label="GitHub"
              className="flex items-center justify-center size-6 rounded text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors">
            ...
            {/* X */}
            <a href="https://x.com/acme" target="_blank" rel="noopener noreferrer" aria-label="X"
              className="flex items-center justify-center size-6 rounded text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors">
              <svg viewBox="0 0 24 24" className="size-3" fill="currentColor">
            ...
            <button
              ...
              className="flex items-center justify-center size-6 rounded text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors cursor-pointer"
              suppressHydrationWarning
            >
              <svg viewBox="0 0 24 24" className="size-3" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" suppressHydrationWarning>
