...
export const useAetherComputerStore = create<AetherComputerState>()(
  devtools(
    (set, get) => ({
      ...initialState,
...
// Sandbox context
export const useAetherComputerSandboxId = () =>
  useAetherComputerStore((state) => state.currentSandboxId);
...
export const useIsSidePanelOpen = () =>
  useAetherComputerStore((state) => state.isSidePanelOpen);

export const useSetIsSidePanelOpen = () =>
  useAetherComputerStore((state) => state.setIsSidePanelOpen);

export const useIsExpanded = () =>
  useAetherComputerStore((state) => state.isExpanded);

export const useToggleExpanded = () =>
  useAetherComputerStore((state) => state.toggleExpanded);
