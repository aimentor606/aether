/**
 * Adapter: OpenCode SDK ToolPart → AcmeComputer ToolCallInput
 *
 * Converts OpenCode session messages into the ToolCallInput[] format
 * that AcmeComputer expects, enabling the computer panel to display
 * OpenCode tool calls.
 */

import type { MessageWithParts, ToolPart, ToolState } from '@/ui';
import type { ToolCallInput } from '@/components/thread/acme-computer/AcmeComputer';
 ...
 * the ToolCallInput[] format used by AcmeComputer.
 */
