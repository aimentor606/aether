...
import { Presentation, AlertTriangle, CheckCircle2, Maximize2 } from 'lucide-react-native';
...
export function PresentationToolView({
  ...
  const presentation_name =
    extractedPresentationName || args.presentation_name || args.presentationName || null;
  ...
  const loadMetadata = useCallback(
    async (retryCount = 0, forceRefresh = false) => {
      ...
      try {
        ...
        const delay = retryCount < 5 ? Math.min(1000 * Math.pow(2, retryCount), 10000) : 5000;
    ...
    return (
      <ToolViewCard
        ...
        <View className="w-full flex-1 items-center justify-center px-6 py-12">
          ...
          <Text className="mb-2 text-center font-roobert-medium text-base text-foreground">
    ...
    return (
      <ToolViewCard
        ...
        <View className="w-full flex-1 items-center justify-center px-6 py-12">
          ...
          <Text className="mb-2 mt-6 font-roobert-semibold text-lg text-foreground">
          ...
          <View className="gap-4 px-4 py-4">
            {error ? (
              <View className="items-center py-8">
                ...
                <Text className="mb-1 font-roobert-medium text-base text-foreground">
                  Failed to Load
                </Text>
                <Text className="text-center font-roobert text-sm text-muted-foreground">
                  {error}
              ...
              <View className="items-center py-8">
                ...
                <Text className="mb-2 font-roobert-medium text-base text-foreground">
              ...
              <>
                ...
                <Pressable
                  ...
                  className="flex-row items-center justify-center gap-2 rounded-xl py-3 active:opacity-70"
                  style={{
                    backgroundColor: isDark
                ...
                <View className="gap-3">
                  {slides.map((slide) => (
                    <PresentationSlideCard
                      ...
                      refreshTimestamp={
                        metadata?.updated_at ? new Date(metadata.updated_at).getTime() : undefined
                      }
