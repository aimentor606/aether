...
{
    "brand_name": "aether",
    "symbol_path": "logos/aether/round-1/logomark-arrow.png",
    "output_dir": "logos/aether/composed/",
    "font_family": "Inter",
    "font_weight": 700,
    "text_color": "#000000",
    "accent_color": "#3B82F6",
...
CLI mode:
    python3 compose_logo.py --brand "aether" --symbol path.png --output-dir out/ \
