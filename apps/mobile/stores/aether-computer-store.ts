...
export const useAetherComputerStore = create<AetherComputerState>((set, get) => ({
  ...initialState,
...
export const useAetherComputerIsOpen = () =>
  useAetherComputerStore((state) => state.isOpen);

// Individual selectors for files state (stable, primitive values)
export const useAetherComputerFilesSubView = () =>
  useAetherComputerStore((state) => state.filesSubView);

export const useAetherComputerCurrentPath = () =>
  useAetherComputerStore((state) => state.currentPath);

export const useAetherComputerSelectedFilePath = () =>
  useAetherComputerStore((state) => state.selectedFilePath);

export const useAetherComputerFilePathList = () =>
  useAetherComputerStore((state) => state.filePathList);

export const useAetherComputerCurrentFileIndex = () =>
  useAetherComputerStore((state) => state.currentFileIndex);

// Individual selectors for pending tool navigation (stable primitives)
export const useAetherComputerPendingToolNavIndex = () =>
  useAetherComputerStore((state) => state.pendingToolNavIndex);

export const useAetherComputerClearPendingToolNav = () =>
  useAetherComputerStore((state) => state.clearPendingToolNav);

// Version history selectors
export const useAetherComputerSelectedVersion = () =>
  useAetherComputerStore((state) => state.selectedVersion);

export const useAetherComputerSelectedVersionDate = () =>
  useAetherComputerStore((state) => state.selectedVersionDate);

export const useAetherComputerVersionActions = () =>
  useAetherComputerStore((state) => ({
