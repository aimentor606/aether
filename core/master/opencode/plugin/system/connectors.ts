/**
 *  Connectors Plugin — thin wrapper around the kconnectors CLI.
...
const ConnectorsPlugin: Plugin = async () => ({
	tool: {
		...
		connector_setup: tool({
			...
			args: {
				connectors: tool.schema.string().describe('JSON array. E.g. [{"name":"github","description":"ai org","source":"cli"}]'),
			},
