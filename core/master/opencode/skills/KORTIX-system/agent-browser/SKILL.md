...
## Live Viewer URL (Required inmaster)
...
Mandatory launch policy inmaster:
...
```bash
agent-browser --sessionmaster open <url>
```

Required behavior:

1. Determine the active session name (default to `kortix` in themaster sandbox)
