...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    const handleDeepLink = async (event: { url: string }) => {
      ...
      // Check for universal links (https://yourbrand.com/share/xxx or https://staging.yourbrand.com/share/xxx)
      const isUniversalLink = parsedUrl.scheme === 'https' &&
        (parsedUrl.hostname === 'yourbrand.com' ||
          parsedUrl.hostname === 'www.yourbrand.com' ||
          parsedUrl.hostname === 'staging.yourbrand.com');
