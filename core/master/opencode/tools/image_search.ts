...
async function enrichImages(images: EnrichedImage[]): Promise<EnrichedImage[]> {
  ...
  // When routed through themaster proxy (REPLICATE_API_URL is set), use AETHER_TOKEN
...
export default tool({
  ...
  async execute(args, _context) {
    ...
    // When routed through themaster proxy (SERPER_API_URL is set), use AETHER_TOKEN
