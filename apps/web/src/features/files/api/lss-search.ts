/**
 * LSS (Local Semantic Search) API — semantic search via the Aether Master endpoint.
 *
 * Calls the `/lss/search` route on Aether Master, which spawns the `lss` CLI
...
export async function searchLss(
  ...
  // Build search URL — the server URL points to Aether Master (port 8000),
