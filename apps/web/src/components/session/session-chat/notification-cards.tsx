...
import { Brain, ChevronDown, ChevronRight, Cpu, Layers, Loader2, MessageSquare, Scissors, Terminal } from "lucide-react";
...
export function DCPNotificationCard({
	...
	const hasDetails =
		hasItems || notification.distilled || notification.summary;
				...
				<div className="flex items-center gap-1.5 ml-auto">
					{notification.reason && (
						<span className="text-[10px] px-1.5 py-0.5 rounded-full bg-muted/60 text-muted-foreground/70">
							{DCP_REASON_LABELS[notification.reason] ||
								notification.reason}
						</span>
					)}
