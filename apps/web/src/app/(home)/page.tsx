  ...
  return (
    <div className="flex items-start gap-3 p-4 rounded-xl border border-border/40 bg-card/20">
      ...
      <div>
        ...
        <p className="text-[13px] text-muted-foreground/50 mt-0.5 leading-relaxed">
          {desc}
        </p>
      </div>
    </div>
  ...
  return (
    <BackgroundAALChecker>
      <div className="relative bg-background">
                ...
                {[
                  {
                    ...
                    title: 'Agents',
                    desc: 'Markdown files with their own identity, permissions, tools, and triggers. A support agent, a bookkeeper, a recruiter — each a specialist.',
                  },
                  {
                    icon: <Sparkles className="size-4" />,
                    title: 'Skills',
                    desc: 'Reusable knowledge packs that teach agents how to do real work. 60+ built-in: coding, browser automation, deep research, legal writing, spreadsheets, and more.',
                  },
                  {
                    icon: <RefreshCw className="size-4" />,
                    title: 'Autowork',
                    desc: 'The autonomous execution loop. An agent works until the task is done, self-verifies, and only stops when it can prove the result is correct.',
                  },
                  {
                    icon: <Zap className="size-4" />,
                    title: 'Triggers',
                    desc: 'Time-driven or event-driven. Cron schedules and webhooks with prompt, command, or HTTP actions. Git-versionable config. Morning briefings, recurring jobs, real-time reactions.',
                  },
                  {
                    icon: <Brain className="size-4" />,
                    title: 'Memory',
                    desc: 'Persistent and filesystem-based. Semantic search across all sessions. Every decision, preference, and context is retained. The longer it runs, the smarter it gets.',
                  },
                  {
                    icon: <GitFork className="size-4" />,
                    title: 'Orchestration',
                    desc: 'One agent delegates to many. Projects, background sessions, parallel sub-agents. A primary orchestrator decomposes work and tracks it to completion.',
                  },
                  {
                    ...
                    desc: (
                      <>
                        ...
                        — an open foundation for agent skills, tools, and
                        commands.
                      </>
                    ),
                  },
          ...
          <section className="max-w-3xl mx-auto px-6 py-10 sm:py-14">
            ...
            <Reveal delay={0.1}>
              <p className="text-base text-muted-foreground/60 leading-relaxed max-w-2xl mb-8">
                Connect your tools. Configure your agents. Deploy them. Check in
                when you want.
              </p>
            </Reveal>
            ...
            <div className="flex flex-col gap-10">
              ...
              <Reveal>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground/60 leading-relaxed mb-4 max-w-xl">
                    Every tool your company uses — OAuth apps, MCP servers, REST
                    APIs, CLI tools, environment variables. If it has an
                    interface, Aether connects to it. 3,000+ integrations
                    available, and custom ones are trivial to add.
                  </p>
              ...
              <Reveal>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground/60 leading-relaxed mb-4 max-w-xl">
                    Define agents, attach skills, set up triggers, create
                    commands. Each agent is a markdown file with its own
                    identity, permissions, and activation rules. Compose them
              ...
              <Reveal>
                <div>
                  ...
                  <p className="text-sm text-muted-foreground/60 leading-relaxed mb-4 max-w-xl">
                    ...
                    You check in from the dashboard, your phone, or your
                    team&apos;s messaging platform — whenever you want.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <IntegrationPill
                      icon={<Globe className="size-4 text-foreground/60" />}
                      name="Web"
                    />
                    <IntegrationPill
                      icon={
                        <Smartphone className="size-4 text-foreground/60" />
                      }
                      name="iOS / Android"
                    />
                    <IntegrationPill domain="slack.com" name="Slack" />
        ...
        <div
          className={cn(
            'fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1.5 px-1.5 py-1.5 rounded-full border border-border/50 bg-background/95 backdrop-blur-md transition-colors duration-300',
            showFloatingCta
