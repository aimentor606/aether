  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold flex items-center gap-2" data-testid="admin-feature-flags-heading">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm" onClick={() => flags.refetch()} data-testid="refresh-flags-button">
            <RefreshCw className="h-4 w-4 mr-1" /> Refresh
          </Button>
          <Button size="sm" onClick={() => setCreateOpen(true)} data-testid="add-flag-button">
