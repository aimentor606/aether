...
python scripts/tts.py speak "Hello, this ismaster speaking."
...
```bash
python scripts/tts.py speak "Welcome to themaster Weekly. I'm your host, and today we're diving into autonomous AI agents." \
