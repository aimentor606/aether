...
interface AcmeComputerState {
  ...
  // Clear pending tool nav after AcmeComputer processes it
...
export const useAcmeComputerStore = create<AcmeComputerState>((set, get) => ({
  ...initialState,
...
export const useAcmeComputerActiveView = () => 
  useAcmeComputerStore((state) => state.activeView);

export const useAcmeComputerIsOpen = () =>
  useAcmeComputerStore((state) => state.isOpen);

// Individual selectors for files state (stable, primitive values)
export const useAcmeComputerFilesSubView = () =>
  useAcmeComputerStore((state) => state.filesSubView);

export const useAcmeComputerCurrentPath = () =>
  useAcmeComputerStore((state) => state.currentPath);

export const useAcmeComputerSelectedFilePath = () =>
  useAcmeComputerStore((state) => state.selectedFilePath);

export const useAcmeComputerFilePathList = () =>
  useAcmeComputerStore((state) => state.filePathList);

export const useAcmeComputerCurrentFileIndex = () =>
  useAcmeComputerStore((state) => state.currentFileIndex);

// Individual selectors for pending tool navigation (stable primitives)
export const useAcmeComputerPendingToolNavIndex = () =>
  useAcmeComputerStore((state) => state.pendingToolNavIndex);

export const useAcmeComputerClearPendingToolNav = () =>
  useAcmeComputerStore((state) => state.clearPendingToolNav);

// Version history selectors
export const useAcmeComputerSelectedVersion = () =>
  useAcmeComputerStore((state) => state.selectedVersion);

export const useAcmeComputerSelectedVersionDate = () =>
  useAcmeComputerStore((state) => state.selectedVersionDate);

export const useAcmeComputerVersionActions = () =>
  useAcmeComputerStore((state) => ({
