...
export async function startKortixMaster(port: number, fixture: RuntimeFixture, extraEnv: Record<string, string> = {}): Promise<StartedServer> {
  const proc = spawn('bun', ['run', 'src/index.ts'], {
    cwd: '/Users/markokraemer/Projects/heyagi/computer/core/master',
    ...
    env: {
      ...
      AETHER_WORKSPACE_ROOT: fixture.workspaceRoot,
      S6_ENV_DIR: fixture.s6EnvDir,
      AETHER_MASTER_PORT: String(port),
      OPENCODE_HOST: '127.0.0.1',
      OPENCODE_PORT: String(port + 1000),
      AETHER_DISABLE_CORE_SUPERVISOR: 'true',
      AETHER_DISABLE_AUTH_SYNC: 'true',
      ...extraEnv,
    },
  })
