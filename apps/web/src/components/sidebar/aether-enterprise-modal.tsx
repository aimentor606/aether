...
export function AetherEnterpriseModal({
  children,
  open: controlledOpen,
          ...
          <div className="p-6 lg:p-8 flex flex-col bg-white dark:bg-black relative h-full overflow-y-auto border-r border-gray-200 dark:border-gray-800">
            <div className="relative z-10 flex flex-col h-full">
              <div className="mb-6 flex-shrink-0">
                <AetherLogo size={30} variant="logomark" />
              </div>
              ...
              <div className="mb-6 flex-shrink-0">
                ...
                <p className="text-base lg:text-lg text-muted-foreground mb-6 leading-relaxed">
                  Schedule a strategy session with our solution architects to
                  explore how custom AI workers can transform your specific
          ...
          <div className="bg-white dark:bg-[#171717] h-full overflow-hidden">
            <div className="h-full overflow-auto">
              <Cal
                ...
                calLink="team/aether/enterprise-demo"
...
export const AetherProcessModal = AetherEnterpriseModal;
