...
export const PROVIDER_REGISTRY: ProviderDef[] = [
  ...
  },
  {
    ...
    name: 'LiteLLM',
    category: 'llm',
    envKeys: ['LITELLM_MASTER_KEY'],
    envUrlKey: 'LITELLM_URL',
    defaultUrl: 'http://litellm:4000',
    helpUrl: 'https://docs.litellm.ai/docs/proxy/',
    description: 'Unified LLM gateway (100+ providers, 300+ models)',
  },
  {
    id: 'gemini',
    name: 'Google Gemini',
